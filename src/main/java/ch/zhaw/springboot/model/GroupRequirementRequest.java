...
public class GroupRequirementRequest {
    ...
    public GroupRequirementRequest(long id, String name, boolean generateEqualGroups, int groupSize, boolean groupByPersonality, List<Long> courseIds, List<RequirementWeightRequest> weightRequests) {
        this.id = id;
        this.name = name;
