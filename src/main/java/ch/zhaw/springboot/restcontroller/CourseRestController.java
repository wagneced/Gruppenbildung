...
public class CourseRestController {
    ...
    public ResponseEntity<Long> createCourse(@RequestBody CourseRequest request) {
        try {
            ...
            Optional<GroupRequirement> optRequirement = this.groupRequirementRepository
                    .findById(request.groupRequirementId);
    ...
    public ResponseEntity<Void> removeCourseMemeber(@PathVariable("courseId") long courseId,
